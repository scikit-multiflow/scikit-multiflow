...
from skmultiflow.utils.utils import add_values_in_dict
...
def test_add_values_in_dict():
    a = {0: 1, 2: 1}
    b = {1: 1, 2: 1, 3: 0}

    c = add_values_in_dict(a, b, inplace=False)
    ...
    add_values_in_dict(a, b, inplace=True)
