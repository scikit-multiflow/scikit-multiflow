...
def demo():
    ...
    This demo tests the OzaBaggingADWINClassifier using KNNAdwin as base estimator
    ...
    clf = OzaBaggingADWINClassifier(base_estimator=KNNAdwin(n_neighbors=8, max_window_size=2000, leaf_size=30),
