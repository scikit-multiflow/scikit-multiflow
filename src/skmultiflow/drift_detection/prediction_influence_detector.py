...
class predictionInfluenceDetector(BaseSKMObject, metaclass=ABCMeta):
    ...
    def calculate_density(self):
        ...
        predictionInfluenceDetector.test_density(self, subset_TN, subset_FP, subset_FN, subset_TP)

    def test_density(self, subset_TN, subset_FP, subset_FN, subset_TP):
        for chunk in range(self.n_time_windows - 1):
            for feature in range(self.stream.n_features):
                ...
                if len(TP) > 10 and len(FN) > 10:
                    ...
                    result = None
                self.table_influence_on_positive.append([feature, chunk, len(TP),
                ...
                if len(TN) > 10 and len(FP) > 10:
                    ...
                    result = None
                self.table_influence_on_negative.append([feature, chunk, len(TN),
