...
class HoeffdingAdaptiveTreeRegressor(HoeffdingTreeRegressor):
    ...
    .. code-block:: python
       ...
       hoeffding_adaptive_tree_regressor = HoeffdingAdaptiveTreeRegressor(max_byte_size=33554432,
       ...
       while n_samples < max_samples and stream.has_more_samples():
           ...
           y_pred = hoeffding_adaptive_tree_regressor.predict(X)
           if y[0] == y_pred[0]:
               correct_cnt += 1
       ...
       print('Hoeffding Adaptive Tree Regressor accuracy: {}'.format(correct_cnt / n_samples))
    """
